(function (){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Nicolas Inoue'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'guarulhense'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/g, function(acumulado){
        return acumulado.toUpperCase();
    }));
    ...
    */
    ...
    function getMonthNumber(monthName){
        var arrMonths = {'janeiro': '01', 'fevereiro': '02', 'março': '03', 'abril': '04', 'maio': '05', 'junho': '06', 'julho': '07', 'agosto': '08', 'setembro': '09', 'outubro': '10', 'novembro': '11', 'dezembro': '12'};
        var numMonth = monthName.replace(monthName, arrMonths[monthName]);
        return numMonth;
    };
