...
*/
var pessoa = {nome: 'Nicolas', sobrenome: 'Inoue', sexo:'Masculino', idade: 21, altura 1.77, peso: 63, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Nicolas Inoue!'
...
*/
pessoa.andar(4); pessoa.andar(5); pessoa.andar(1);
