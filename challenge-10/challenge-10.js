(function (){
    ...
    */
    function isOperatorValid(operator){
        return operation[operator] === operation['+'] || operation[operator] === operation['-'] || operation[operator] === operation['*'] || operation[operator] === operation['/'] || operation[operator] === operation['%'];
    }
