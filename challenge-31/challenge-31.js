      ...
      return {
        init: function(){
          ...
          function appendCarInfoIntoList(){
            ...
            appendRemoveEventToButton(newRemoveButton);
            ...
            newLiCarInfo.appendChild(newRemoveButton);
          };

          function appendRemoveEventToButton(newButton){
            newButton.type = "submit";
            newButton.appendChild(doc.createTextNode('Remover'));
