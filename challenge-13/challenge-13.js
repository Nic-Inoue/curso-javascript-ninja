(function(){
    ...
    */
    ...
    var isBiggerThan7 = brasil.every(function(item){
        return item.length > 7;
    });
    console.log(isBiggerThan7 ? 'Sim, todos os estados tem mais de 7 letras!':'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var isCearaPartOfBrasil = brasil.some(function(item){
        return item === 'Ceará';
    });
    console.log(isCearaPartOfBrasil ? 'Ceará está incluído!' : 'Ceará não está incluído! :c');
