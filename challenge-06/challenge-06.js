...
desafio.
*/
var teams = ['Corinthians', 'São Paulo', 'Vasco', 'Santos', 'Flamengo'];
...
function showTeamPosition(number){
    if (typeof number !== 'number' || !number || number < 1 || number > 5){
...
function convertToHex(colorString){
    ...
    return 'O hexadecimal para a cor ' + colorString + ' é ' + hex+ '.'
};
