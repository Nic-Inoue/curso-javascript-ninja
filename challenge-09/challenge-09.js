...
function calculator(number1, number2){
    return function callbackFunction(callback){
...
console.log(sum(function(){return 3 + 5}));
...
console.log(subtraction(function(){return 8 - 4}));

console.log( 'O resultado da multiplicação é:' );
console.log(multiplication(function(){return 3 * 3}));

console.log( 'O resultado da divisão é:' );
console.log(division(function(){return 12 / 4}));

console.log( 'O resto da divisão é:' );
console.log(mod(function(){return 5 % 3}));