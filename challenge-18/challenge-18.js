(function(){
    ...
    */
    ...
    function cleanCPF(cpf){
        var cpfOnlyNumber = cpf.replace(/\D/g, '');
    ...
    */
    ...
    // function cpfStandard(regex, first3, second3, third3, last2){
    //     var arrFirst9WithDots = [first3, second3, third3].join('.');
    //     var arrCpfStandard = [arrFirst9WithDots, last2].join ('-');
    //     return arrCpfStandard;
    // }
    function cpfReplacer(cpf){
        return cleanCPF(cpf).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4');
    };

    console.log(cpfReplacer("049-214 3421-1"));
    console.log(cpfReplacer("210.458.522-05"));
    console.log(cpfReplacer("735 500 794 - 22"));
    console.log(cpfReplacer("101.123-131x32"));
    ...
    */
    ...
    var monthSentence = 'Os meses de janeiro, junho e julho começam com a letra j';
    console.log(monthSentence.match(/ju\w{3}/g));
    ...
    */
    ...
    var htmlSentence = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
    console.log(htmlSentence.match(/<\w+>/g));
    ...
    */
    ...
    var htmlSentence2 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
    console.log(htmlSentence2.match(/<\w+><\/\w+>/g));
    ...
    */
    ...
    var htmlSentence3 = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
    var regexCode = /<(\w+)>([^<]+)<\/\w+>/g;
    var htmlResult = htmlSentence3.replace(regexCode, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n');
